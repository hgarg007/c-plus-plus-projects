...
static unsigned int sqlctx = 670139;
...
"select id  from employee where id=:b0           ";

 static const char *sq0004 = 
"select id ,name ,age ,gender ,designation ,address ,contactNumber  from empl\
oyee where name=:b0           ";

 static const char *sq0006 = 
"select id ,name ,age ,gender ,designation ,address ,contactNumber  from empl\
oyee  order by id asc             ";
...
"select id ,name ,age ,gender ,address ,designation ,contactNumber  from empl\
oyeebackup where id=:b0           ";
...
"select id ,name ,age ,gender ,address ,designation ,contactNumber  from EMPL\
OYEEBackup  order by id asc             ";

 static const char *sq0028 = 
"select id ,name ,age ,gender ,address ,designation ,contactNumber  from EMPL\
OYEEBackupm  order by id asc             ";
...
{12,4130,1,0,0,
5,0,0,0,0,0,27,26,0,0,4,4,0,1,0,1,97,0,0,1,97,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,48,0,9,53,0,0,1,1,0,1,0,1,3,0,0,
55,0,0,2,0,0,13,55,0,0,1,0,0,1,0,2,3,0,0,
74,0,0,2,0,0,15,63,0,0,0,0,0,1,0,
89,0,0,3,0,0,30,64,0,0,0,0,0,1,0,
104,0,0,4,106,0,9,82,0,0,1,1,0,1,0,1,97,0,0,
123,0,0,4,0,0,13,84,0,0,7,0,0,1,0,2,3,0,0,2,97,0,0,2,3,0,0,2,1,0,0,2,97,0,0,2,
97,0,0,2,97,0,0,
166,0,0,4,0,0,15,94,0,0,0,0,0,1,0,
181,0,0,5,0,0,30,95,0,0,0,0,0,1,0,
196,0,0,6,110,0,9,118,0,0,0,0,0,1,0,
211,0,0,6,0,0,13,121,0,0,7,0,0,1,0,2,3,0,0,2,97,0,0,2,3,0,0,2,1,0,0,2,97,0,0,2,
97,0,0,2,97,0,0,
254,0,0,6,0,0,15,133,0,0,0,0,0,1,0,
269,0,0,7,0,0,30,134,0,0,0,0,0,1,0,
284,0,0,8,22,0,2,143,0,0,0,0,0,1,0,
299,0,0,9,58,0,3,209,0,0,7,7,0,1,0,1,3,0,0,1,97,0,0,1,3,0,0,1,1,0,0,1,97,0,0,1,
97,0,0,1,97,0,0,
342,0,0,10,0,0,30,213,0,0,0,0,0,1,0,
357,0,0,11,29,0,2,223,0,0,0,0,0,1,0,
372,0,0,12,53,0,3,224,0,0,0,0,0,1,0,
387,0,0,13,0,0,30,228,0,0,0,0,0,1,0,
402,0,0,14,104,0,9,242,0,0,1,1,0,1,0,1,3,0,0,
421,0,0,14,0,0,13,244,0,0,7,0,0,1,0,2,3,0,0,2,97,0,0,2,3,0,0,2,1,0,0,2,97,0,0,
2,97,0,0,2,97,0,0,
464,0,0,15,0,0,30,259,0,0,0,0,0,1,0,
479,0,0,14,0,0,15,260,0,0,0,0,0,1,0,
494,0,0,16,110,0,9,275,0,0,1,1,0,1,0,1,3,0,0,
513,0,0,16,0,0,13,277,0,0,7,0,0,1,0,2,3,0,0,2,97,0,0,2,3,0,0,2,1,0,0,2,97,0,0,
2,97,0,0,2,97,0,0,
556,0,0,16,0,0,15,293,0,0,0,0,0,1,0,
571,0,0,17,0,0,30,294,0,0,0,0,0,1,0,
   sqlstm.sqadto[1] = (unsigned short )0;
   sqlstm.sqtdso[1] = (unsigned short )0;
   sqlstm.sqhstv[2] = (unsigned char  *)&age;
   ...
   sqlstm.sqhstv[3] = (unsigned char  *)&gender;
   ...
   sqlstm.sqhstv[4] = (unsigned char  *)designation;
   ...
   sqlstm.sqhstv[5] = (unsigned char  *)address;
   ...
   sqlstm.sqhstv[6] = (unsigned char  *)contactNumber;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "delete  from EMPLOYEE ";
 sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "insert into employee  values (:b0,:b1,:b2,:b3,:b4,:b5,:b6)";
  sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "delete  from EMPLOYEEBACKUPM ";
  sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "insert into EMPLOYEEBACKUPM  select *  from EMPLOYEE ";
  sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqadto[4] = (unsigned short )0;
  sqlstm.sqtdso[4] = (unsigned short )0;
  sqlstm.sqhstv[5] = (unsigned char  *)designation;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "insert into employee  values (id.nextval ,:b0,:b1,:b2,:b3,:\
b4,:b5)";
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (unsigned char  *)&age;
  ...
  sqlstm.sqadto[1] = (unsigned short )0;
  sqlstm.sqtdso[1] = (unsigned short )0;
  sqlstm.sqhstv[2] = (unsigned char  *)&gender;
  ...
  sqlstm.sqadto[2] = (unsigned short )0;
  sqlstm.sqtdso[2] = (unsigned short )0;
  sqlstm.sqhstv[3] = (unsigned char  *)designation;
  ...
  sqlstm.sqadto[4] = (unsigned short )0;
  sqlstm.sqtdso[4] = (unsigned short )0;
  sqlstm.sqhstv[5] = (unsigned char  *)contactNumber;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "insert into employeeBackup  values (id.currval ,:b0,:b1,:b2\
,:b3,:b4,:b5)";
  sqlstm.iters = (unsigned int  )1;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "delete  from employee  where id=:b0";
   sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update employee  set AGE=:b0 where id=:b1";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqlety = (unsigned short)4352;
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqhstv[0] = (unsigned char  *)&age;
    sqlstm.sqhstl[0] = (unsigned long )sizeof(int);
    sqlstm.sqhsts[0] = (         int  )0;
    sqlstm.sqindv[0] = (         short *)0;
    sqlstm.sqinds[0] = (         int  )0;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update employeebackup  set AGE=:b0 where id=:b1";
    sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update employee  set GENDER=:b0 where id=:b1";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqlety = (unsigned short)4352;
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqhstv[0] = (unsigned char  *)&gender;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update employeebackup  set GENDER=:b0 where id=:b1";
    sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update employee  set NAME=:b0 where id=:b1";
    sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update employeebackup  set NAME=:b0 where id=:b1";
    sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update employee  set ADDRESS=:b0 where id=:b1";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqlety = (unsigned short)4352;
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqhstv[0] = (unsigned char  *)address;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update employeebackup  set ADDRESS=:b0 where id=:b1";
    sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update employee  set contactNumber=:b0 where id=:b1";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqlety = (unsigned short)4352;
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqhstv[0] = (unsigned char  *)contactNumber;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update employeebackup  set contactNumber=:b0 where id=:b1";
    sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update employee  set designation=:b0 where id=:b1";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqlety = (unsigned short)4352;
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqhstv[0] = (unsigned char  *)designation;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update employeebackup  set designation=:b0 where id=:b1";
    sqlstm.iters = (unsigned int  )1;
